package com.example.animationplayground.transition_animation.data;
...
public class SceneryRepository {
    private static final List<Scenery> sceneries = Arrays.asList(new Scenery(1,
                    "羅東運動公園",
    ...
    public static List<Scenery> getScenerys() {

        return sceneries;
    }

    public static Scenery getSceneryById(int id) {
        for (Scenery scenery : getScenerys()) {
            if (scenery.getId() == id) {
                return scenery;
            }
        }
